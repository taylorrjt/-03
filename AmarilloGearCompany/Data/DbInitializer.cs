...
namespace AmarilloGearCompany.Data
{
    public class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            {
                new Operator{ FirstName = "John", LastName = "Wayne"},
                new Operator{ FirstName = "Hannah", LastName = "Jones"},
                new Operator{ FirstName = "Jane", LastName = "Johnston"},
                new Operator{ FirstName = "Anna", LastName = "Ace"}
            };
